...
import { navigation, additionalServices, contactInfo } from '../data/constants'
    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="font-semibold text-lg mb-4">New Top C.A.</h3>
            <p className="text-gray-300 mb-4">
              Transformando espacios con la belleza natural del mármol y granito. 
              Calidad, experiencia y acabados excepcionales desde 2010.
            </p>
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; 2026 New Top C.A. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
