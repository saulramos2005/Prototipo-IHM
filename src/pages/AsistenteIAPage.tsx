          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-200">
                Sube una foto de tu espacio y recibe sugerencias personalizadas
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              Sube una foto estilo negativo de tu proyecto y visualiza cómo se
              vería con diferentes tonos de mármol y granito
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              Recibe recomendaciones basadas en IA sobre los mejores materiales
              según el estilo de tu espacio
            </p>
          </div>
        </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Calacatta Gold - Perfecto para cocinas modernas con
                            iluminación natural
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Combina con accesorios cromados para resaltar las
                            vetas doradas
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            Travertino Romano - Similar estética, precio más
                            accesible
                          </p>
                        </div>
                      </div>
